...
class CreateSites : protected Pointers {
 ...
 private:
  ...
  tagint nx,ny,nz;              //update to tagint by bdwu 160704
  tagint xlo,xhi,ylo,yhi,zlo,zhi;   //update to tagint by bdwu 160704
  ...
  //void random_sites();             deleted by bdwu 160703
  //void random_connectivity();      deleted by bdwu 160703

  void offsets(double **);
  //void offsets_2d(int, double **, double, double, int, int **);  deleted by bdwu 160703

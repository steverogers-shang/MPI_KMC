			 ...
			 int nrepeat, double scale, double delay)
{
  ...
  if (logfreq == 0) {
    //tnew = ceil(tcurrent/delta) * delta;     //deleted by bdwu 170226
    if (delta == 0) tnew = 0.0; //deleted by bdwu 170301
    else tnew = ceil(tcurrent/delta) * delta; //deleted by bdwu 170301        

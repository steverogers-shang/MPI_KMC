...
//baodong
  ...
  virtual void count_vac(int, int *, std::map<int,int> *) {}
 ...
 protected:
  ...
  // virtual void iterate_rejection(double); //delete by bdwu 160703
  // void iterate_update_only(double,double);//delete by bdwu 160703

  // typedef void (AppLattice::*FnPtrSweep)(int, int *);//delete by bdwu 170228
  // FnPtrSweep sweep;                         // ptr to< sweep functions
  // void sweep_nomask_nostrict(int, int *);//delete by bdwu 170228
  // void sweep_mask_nostrict(int, int *);//delete by bdwu 170228
  // void sweep_nomask_strict(int, int *);//delete by bdwu 170228
  // void sweep_mask_strict(int, int *);//delete by bdwu 170228
  ...
  //int id2color(int);//delete by bdwu 170228
  // int find_border_sites(int);//delete by bdwu 170228
  // void boundary_clear_mask(int);//delete by bdwu 170228
